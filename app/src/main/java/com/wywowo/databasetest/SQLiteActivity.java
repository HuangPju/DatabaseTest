...
public class SQLiteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void creatView(){
        ...
        twopage = (Button)findViewById(R.id.twopage);
    }
    ...
    private void setListener(){
        ...
        two.setOnClickListener(new TwoeListener());
    ...
    class DeleteListener implements View.OnClickListener {
     ...
     class TwoeListener implements View.OnClickListener {
         @Override
         public void onClick(View view) {
             StuDBHelper dbHelper = new StuDBHelper(SQLiteActivity.this,"stu_db",null,1);
             //得到一个可写的数据库
             ...
             String sql = "create table two_table(id int,sname varchar(20),sage int,ssex varchar(10))";
             db.execSQL(sql);
         }
     }
}
